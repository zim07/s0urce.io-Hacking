...
function checkPwn(force) {
	...
	//List is still dead, will be updated sometime
...
//This is the export memory, to import a bot memory, just paste the memory into the console
...
// Tell the user how to use the tool
